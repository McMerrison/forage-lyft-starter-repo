...
class TestPalindrome(unittest.TestCase):
    def test_battery_should_be_serviced(self):
        ...
        car = CarFactory.create_palindrome(today, last_service_date, current_mileage, last_service_mileage, warning_light_is_on)
        self.assertTrue(car.needs_service())
    ...
    def test_engine_should_be_serviced(self):
        ...
        car = CarFactory.create_palindrome(last_service_date, last_service_date, current_mileage, last_service_mileage, warning_light_is_on)
        self.assertTrue(car.needs_service())
